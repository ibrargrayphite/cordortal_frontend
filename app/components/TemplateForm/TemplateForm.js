    ...
    const handleDeleteConsentForm = async () => {
        ...
        try {
            if (formData?.id) {
                ...
                //showSuccess("Consent form deleted!");
            }
            setIsEditing(false);
            setFormData(null);
    ...
    return (
        <Form>
            ...
            <div className={styles.fullPageEditorContainer}>
                ...
                <div
                    className={`${styles.editorContainer} ${isSigned ? styles.fullPreview : ""}`}
                >
                    {isSigned ? (
                ...
                {mode === "consent" ? (
                    <>
                        {isSigned ? (
                            ...
                            // If not signed full editing actions
                            <>
                                <Button
