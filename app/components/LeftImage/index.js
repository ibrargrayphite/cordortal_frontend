      ...
      <Container>
        <Row className={styles.section2}>
          <Col md={6} xs={12} className={styles.headerGroup2}>
            <Image className={styles.leftimageWidth} src={mediaSource} alt="providing exceptional dental care with a focus on innovation, comfort, and patient satisfaction w-[70%]"  width={100} height={350} />
          </Col>
          <Col md={6} xs={12}>
            {description ? (
