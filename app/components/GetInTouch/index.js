          ...
          <div className="w-full md:w-1/2 flex items-center justify-center p-8 md:p-12" style={{backgroundColor: 'var(--main-accent-color)'}}>
            <form onSubmit={handleSubmit} className="w-full max-w-md space-y-7">
              <div className="mb-6 text-center">
                <h2 className="text-3xl font-bold tracking-tight text-foreground mb-2">{headline}</h2>
              ...
              <div className="flex gap-4">
                ...
                <div className="w-1/2">
                  <label htmlFor="phone" className="block text-sm font-medium mb-1 text-foreground">Phone Number</label>
                  <Input
                    id="phone"
                    type="text"
                    value={phoneNumber}
